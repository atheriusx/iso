...
module.exports = async () => {
  ...
  let LeaderBoard = await client.guilds.cache.get(sistem.SERVER.ID).channels.cache.get("1017435229792768020").messages.fetch("1017602711987966043")
  let LeaderBoardiki = await client.guilds.cache.get(sistem.SERVER.ID).channels.cache.get("1017435229792768020").messages.fetch("1017602713116229722")
  if("1017435229792768020") checkingLeader()
  setInterval(() => {
    if("1017435229792768020") checkingLeader()
  }, 600000);
